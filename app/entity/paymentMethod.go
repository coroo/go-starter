...
type PaymentMethod struct {
	...
	InitPaymentCode  		string    		`gorm:"type:varchar(191) default null" json:"init_payment_code"`
	RenewalPaymentCode 		string    		`gorm:"type:varchar(191) default null" json:"renewal_payment_code"`
	FastpayCode 		 	string    		`gorm:"type:varchar(191) NOT NULL" json:"fastpay_code"`
	BankCode 		 		string    		`gorm:"type:varchar(191) default null" json:"bank_code"`
