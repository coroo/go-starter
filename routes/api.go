...
func Api() {
	...
	syUserInvoiceGroup := router.Group(API_PREFIX + "syUserInvoice")
	{
	...
	syETLGroup := router.Group(API_PREFIX + "syEtl")
	{
	...
	odsETLGroup := router.Group(API_PREFIX + "odsEtl")
	{
	...
	syOdsETLGroup := router.Group(API_PREFIX + "syOdsEtl")
	{
